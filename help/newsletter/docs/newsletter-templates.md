...
Vorlagen sind fertige Inhaltsbausteine für wiederkehrende Rundschreiben – etwa eine Konzertankündigung, ein Nachbericht oder das monatliche Standard-Rundschreiben. Beim Anlegen eines Newsletters lädst du eine Vorlage und passt nur noch die konkreten Angaben an.
...
In der Übersicht öffnest du eine Vorlage über **Bearbeiten**. Name, Beschreibung und Inhalt lassen sich dort ändern.
...
Beim Anlegen eines Newsletters wählst du sie unter **Vorlage laden (optional)** aus – der Inhalt wird in den Editor übernommen und ist dort frei bearbeitbar. Angeboten werden alle Vorlagen, im Auswahlfeld nach Kontext gruppiert – zuerst die globalen, danach die Vorlagen je Projekt. Näheres dazu unter [Newsletter schreiben und versenden](newsletter-compose).
