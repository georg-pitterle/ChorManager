...
Diese Anleitung zeigt, wie du Sponsoren anlegst, ihre Daten pflegst, Vereinbarungen erfasst und Kontakte protokollierst. Sie setzt voraus, dass du bereits im [Sponsoring-Modul](sponsoring) bist.
...
Auf der Detailseite eines Sponsors findest du drei Reiter: **Stammdaten**, **Vereinbarungen** und **Kontakthistorie**. Im Reiter Stammdaten bearbeitest du Kontakt- und Adressdaten und übernimmst sie mit **Speichern**. Darunter lädst du Anhänge hoch, die zum Sponsor selbst gehören – etwa das Logo oder Mediadaten.

Hast du den Sponsor nicht selbst angelegt, kannst du die Stammdaten ansehen, aber nicht ändern; dafür ist das Recht "Sponsoring verwalten" nötig.
...
- **E-Mail und Website müssen gültig sein.** Wird ein Format erkannt, das keine echte E-Mail-Adresse bzw. keine echte URL ist, lehnt der Chor-Manager das Speichern ab.
- **Bei einer Vereinbarung sind Sponsor und Betrag Pflichtfelder.** Beim Betrag kannst du Komma oder Punkt als Dezimaltrennzeichen verwenden (z. B. `1500,00` oder `1500.00`).
